...
public:
	...
	void printTreeVisually(int totalSpace)const
	{
		printTreeVisuallyHelper(root,totalSpace );
	}
...
private:
	...
	void printTreeVisuallyHelper(TreeNode<NODETYPE>* ptr, int totalSpace)const
	{
		...
		{
			printTreeVisuallyHelper(ptr->right, totalSpace + 5);
			for (int i = 0; i < totalSpace; i++)
			{
				std::cout << " ";
			}
			std::cout << ptr->data << std::endl;
			printTreeVisuallyHelper(ptr->left, totalSpace + 5);
